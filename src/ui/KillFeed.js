    ...
    updateDisplay() {
        ...
        this.kills.forEach((kill, index) => {
            ...
            killRow.style.cssText = `
                background: rgba(26, 36, 71, 0.85);
                border-left: 2px solid ${kill.isYouKiller ? '#ef4e23' : kill.isYouVictim ? '#ef4e23' : 'rgba(239, 78, 35, 0.25)'};
                padding: 6px 10px;
                display: flex;
                align-items: center;
                font-size: 12px;
            ...
            const killerColor = kill.isYouKiller ? '#ef4e23' : (kill.killerTeam === 'orange' ? '#ef4e23' : kill.killerTeam === 'red' ? 'rgba(239, 78, 35, 0.6)' : 'rgba(239, 78, 35, 0.8)');
            ...
            `;
            icon.innerHTML = `
                <svg width="14" height="14" viewBox="0 0 24 24" fill="rgba(239, 78, 35, 0.5)">
            ...
            const victimColor = kill.isYouVictim ? '#ef4e23' : (kill.victimTeam === 'orange' ? '#ef4e23' : kill.victimTeam === 'red' ? 'rgba(239, 78, 35, 0.6)' : 'rgba(239, 78, 35, 0.6)');
